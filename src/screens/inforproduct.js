...
const inforproduct = (props, {navigation}) => {
  const {_id, picture, name, size, price, description} = props.route.params.item;
  console.log(_id, picture, name, size, price,description);
    ...
    <View style={styles.container}>
      <View style={styles.plus}>
        ...
        <View style={{width:Dimensions.get('window').width,flexDirection:'column'}}>
          ...
          <Text style={[styles.title,{fontSize:14,width:250}]}> {description}</Text>
